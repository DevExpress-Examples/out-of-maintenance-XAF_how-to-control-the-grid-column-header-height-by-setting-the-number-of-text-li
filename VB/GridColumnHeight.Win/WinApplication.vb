...
Namespace GridColumnHeight.Win
	Partial Public Class GridColumnHeightWindowsFormsApplication
		...
		Private Sub GridColumnHeightWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
